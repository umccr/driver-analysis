...
option_list <- list(
  ...
  make_option("--dnds_q", action="store", default=0.1, type='double',
  ...
  make_option("--hypermut_sample_cutoff", action="store", default=250, type='integer',
