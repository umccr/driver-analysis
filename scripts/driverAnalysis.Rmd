...
for ( i in 1:length(mafFiles) ) {
  ...
  if ( nrow(signif_genes_table.datasets[[i]]$dNdScv) > 0 ) {
    ...
    saveWidgetFix(as_widget(p), paste0(outDir, "/driver_analysis_dndscv_plot_", datasets.list[i], ".html"), selfcontained = TRUE)
...
for ( i in 1:length(mafFiles) ) {
  ...
  if ( nrow(signif_genes_table.datasets[[i]]$dNdSloc) > 0 ) {
    ...
    ##### Save the plot as html (PLOTLY)
    saveWidgetFix(as_widget(p), paste0(outDir, "/driver_analysis_dndsloc_plot_", datasets.list[i], ".html"), selfcontained = TRUE)
...
for ( i in 1:length(mafFiles) ) {
  ...
  if ( !is.null(signif_genes_table.datasets[[datasets.list[i]]]$OncodriveCLUST) ) {
    ...
    if ( nrow(signif_genes_table.datasets[[datasets.list[i]]]$OncodriveCLUST) > 0 ) {
      ...
      ##### Save the plot as html (PLOTLY)
      saveWidgetFix(as_widget(p), paste0(outDir, "/driver_analysis_oncodriveCLUST_plot_", datasets.list[i], ".html"), selfcontained = TRUE)
...
for ( i in 1:length(mafFiles) ) {
  ...
  if ( nrow(oncodriveFML.res.table[[datasets.list[i]]]) > 0 ) {
    ...
    ##### Save the plot as html (PLOTLY)
    saveWidgetFix(as_widget(p), paste0(outDir, "/driver_analysis_oncodriveFML_plotly_", datasets.list[i], ".html"), selfcontained = TRUE)
