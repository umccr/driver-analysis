...
if ( pchangeStatus ) {
  ...
  output_plot <- list()
  genes <- verify_genes(unlist(signif_genes.methods$dNdScv))
...
if ( pchangeStatus ) {
  ...
  output_plot <- list()
  genes <- verify_genes(unlist(signif_genes.methods$dNdSloc))
...
if ( pchangeStatus ) {
  ...
  output_plot <- list()
  genes <- verify_genes(unlist(signif_genes.methods$OncodriveCLUST))
...
if ( pchangeStatus ) {
  ...
  output_plot <- list()
  genes <- verify_genes(unlist(signif_genes.methods$OncodriveFML))
