...
Table(s) presenting per-dataset [CGI](https://www.cancergenomeinterpreter.org){target="_blank"}-annotated alterations described as biomarkers for the selected tumor type `r if ( runcgiChunk ) { cat(paste0("(", cancer_type.cgi, ").")) } else { c(".") }`
