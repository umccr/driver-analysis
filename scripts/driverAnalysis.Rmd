...
for ( i in 1:length(mafFiles) ) {
  ...
  sink("/dev/null")
  ##### NOTE: the analysis crash when "recovery.dir" paramter (for storing recovery files) is used so currnelty it's set to NULL. Once fixed it can be set to "paste(outDir, "ActiveDriverWGS_recovery", sep="/")"
