...
for ( i in 1:length(mafFiles) ) {
  ...
  signif_genes.datasets[[i]]$ActiveDriverWGS <- unique(c(ActiveDriverWGS.res[[i]]$id[ ActiveDriverWGS.res[[i]]$element_enriched & ActiveDriverWGS.res[[i]]$pp_element <= params$activedriverwgs_p  ], ActiveDriverWGS.res[[i]]$id[ ActiveDriverWGS.res[[i]]$element_enriched & ActiveDriverWGS.res[[i]]$fdr_element <= params$activedriverwgs_fdr ]))
