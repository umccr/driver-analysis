...
if ( pchangeStatus ) {
  ...
  for( i in 1:length(unlist(signif_genes.methods$dNdScv)) ){
    cat("\n#### ", verify_genes(unlist(signif_genes.methods$dNdScv))[i], "\n")
    if ( nrow(gff[HGNC %in% verify_genes(unlist(signif_genes.methods$dNdScv))[i]]) != 0 ) {
      try(lollipops.datasets(mafInfo = mafInfo, datasets  = datasets.list, gene  = unlist(signif_genes.methods$dNdScv)[i]), silent = TRUE)
      cat("\n\n***\n")
    } else {
...
if ( pchangeStatus ) {
  ...
  for( i in 1:length(unlist(signif_genes.methods$dNdSloc)) ){
    cat("\n#### ", verify_genes(unlist(signif_genes.methods$dNdSloc))[i], "\n")
    if ( nrow(gff[HGNC %in% verify_genes(unlist(signif_genes.methods$dNdSloc))[i]]) != 0 ) {
      try(lollipops.datasets(mafInfo = mafInfo, datasets  = datasets.list, gene  = unlist(signif_genes.methods$dNdSloc)[i]), silent = TRUE)
      cat("\n\n***\n")
    } else {
...
if ( pchangeStatus ) {
  ...
  for( i in 1:length(unlist(signif_genes.methods$OncodriveCLUST)) ){
    cat("\n#### ", verify_genes(unlist(signif_genes.methods$OncodriveCLUST))[i], "\n")
    if ( nrow(gff[HGNC %in% verify_genes(unlist(signif_genes.methods$OncodriveCLUST))[i]]) != 0 ) {
      try(lollipops.datasets(mafInfo = mafInfo, datasets  = datasets.list, gene  = unlist(signif_genes.methods$OncodriveCLUST)[i]), silent = TRUE)
      cat("\n\n***\n")
    } else {
...
if ( pchangeStatus ) {
  ...
  for( i in 1:length(unlist(signif_genes.methods$OncodriveFML)) ){
    cat("\n#### ", verify_genes(unlist(signif_genes.methods$OncodriveFML))[i], "\n")
    if ( nrow(gff[HGNC %in% verify_genes(unlist(signif_genes.methods$OncodriveFML))[i]]) != 0 ) {
      try(lollipops.datasets(mafInfo = mafInfo, datasets  = datasets.list, gene  = unlist(signif_genes.methods$OncodriveFML)[i]), silent = TRUE)
      cat("\n\n***\n")
    } else {
